    ...
    )
{
    ...
    try
    {
        CryptographicKeyManagementPlugin * poCryptographicKeyManagementPlugin = ::GetCryptographicKeyManagementPlugin();
        __DebugAssert(nullptr != poCryptographicKeyManagementPlugin);
