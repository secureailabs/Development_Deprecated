...
) throw()
{
	...
	// As a worst case we allocate the entire incoming size, and will shrink when we build the structured buffer
	std::vector<Byte> stlCompressedDestination(unRawBufferSizeInBytes);
