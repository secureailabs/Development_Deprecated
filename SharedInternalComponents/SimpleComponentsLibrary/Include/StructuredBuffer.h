...
class StructuredBuffer : public Object
{
    public:
        ...
        Byte __thiscall GetTypeOfElement(
            _in const std::string strElementName
            ) const;
        const Byte * __thiscall GetRawDataPtrOfElement(
            _in const std::string strElementName
            ) const;
        unsigned int __thiscall GetRawDataSizeInBytesOfElement(
            _in const std::string strElementName
            ) const;
        ...
        StructuredBuffer __thiscall GetBigNumber(
            _in const char * c_szElementName
            ) const;
        ...
        void __thiscall PutBigNumber(
            ...
            _in bool fIsNegative,
            _in unsigned int unNumberOfBits
            );
        void __thiscall PutBuffer(
            _in const char * c_szElementName,
            _in const Byte * c_pbByteArray,
            _in unsigned unSizeInBytes
            );
        void __thiscall PutBuffer(
            _in const char * c_szElementName,
            _in const std::vector<Byte> c_stlBuffer
